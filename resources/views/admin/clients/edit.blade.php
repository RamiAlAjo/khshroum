            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.clients.update', $client->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" class="form-control shadow-sm" name="url" id="url" value="{{ old('url', $client->url) }}" required>
                        @error('url')
                    ...
                    <div class="form-group mt-3">
                        ...
                        @if($client->image)
                            <div class="mt-3">
                                <p>Current Image:</p>
                                <img src="{{ asset('storage/' . $client->image) }}" alt="Client Image" style="max-width: 200px; border-radius: 5px;">
                            </div>
                        @endif
                    </div>
