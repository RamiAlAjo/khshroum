                        ...
                        <div class="col-6 text-center product-item">
                            <a href="{{ route('product.show', $product->id) }}">
                                <div class="card product-card">
                                    <img class="square-img" src="{{ $product->image ? asset('storage/' . $product->image) : asset('images/placeholder.png') }}" alt="{{ $isArabic ? $product->name_ar : $product->name_en }}">
                                    <div class="container">
                                        <h4><b>{{ $isArabic ? $product->name_ar : $product->name_en }}</b></h4>
                                    </div>
